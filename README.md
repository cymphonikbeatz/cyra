...
<p align="center">
  <a href="https://github.com/cymphonikbeatz">Website</a> ·
  <a href="#install">Install</a> ·
  <a href="#everything-it-does">Features</a> ·
  <a href="#private-by-default">Privacy</a> ·
  <a href="CHANGELOG.md">Changelog</a> ·
  <a href="https://github.com/cymphonikbeatz">Contact</a> ·
  <a href="https://sandbox.flutterwave.com/pay/6f04lyagit1n">Support Cyra</a>
</p>

<p align="center">
  <a href="https://github.com/cymphonikbeatz/cyra-utility/releases"><img src="https://img.shields.io/github/v/release/cymphonikbeatz/cyra-utility?label=release&color=4c8dff" alt="Latest release"></a>
  <a href="https://github.com/cymphonikbeatz/cyra-utility/releases"><img src="https://img.shields.io/github/downloads/cymphonikbeatz/cyra-utility/total?color=4c8dff" alt="Downloads"></a>
  <a href="https://github.com/cymphonikbeatz/cyra-utility/actions/workflows/ci.yml"><img src="https://github.com/cymphonikbeatz/cyra-utility/actions/workflows/ci.yml/badge.svg?branch=main&event=push" alt="CI status"></a>
  <a href="#what-you-need"><img src="https://img.shields.io/badge/macOS-14%2B%20Apple%20Silicon%20%26%20Intel-black" alt="macOS 14 and newer, Apple Silicon and Intel"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-GPL--3.0--or--later-blue" alt="License GPL 3.0 or later"></a>
</p>

<p align="center">
  For inquiries, reach out on
  <a href="https://github.com/cymphonikbeatz"><strong>GitHub</strong></a>.
</p>
...
Nobody needs all of it, and Cyra is built around that. The Features page installs and uninstalls whole features: what you uninstall disappears from the entire app and stops loading, so it spends no CPU, memory or energy. Nothing is deleted, and installing again brings your old settings back.
...
- **Bluetooth on sleep.** Switches Bluetooth off while the Mac sleeps, so a laptop in a bag stops stealing the headphones you are listening to elsewhere. Bluetooth you had already turned off stays off, and only what Cyra switched off comes back on wake.
...
To remove Cyra completely, including its settings and permissions:
...
Cyra is local-first, with no account, analytics or tracking. The network is touched only by things you can see: update checks, the speed test, Homebrew actions, temporary screenshot or recording links and feedback you explicitly send. The full story is in the [privacy notes](docs/PRIVACY.md).
...
- A Mac with Apple Silicon or Intel processor
- macOS 14 Sonoma or newer

### Build it yourself

```sh
git clone https://github.com/cymphonikbeatz/cyra-utility.git
cd cyra
...
Xcode Command Line Tools are the only requirement. The [contributing guide](CONTRIBUTING.md) covers the layout and conventions.

## When something misbehaves

The [troubleshooting guide](docs/TROUBLESHOOTING.md) walks through the common cases: the app blocked on first launch, a permission that will not stick, thumbnails showing as icons. To remove Cyra completely, `./Tools/uninstall.sh` quits the app, drops the login item, resets its privacy grants and deletes every trace.
...
Cyra is free and open-source. If it earned its place in your menu bar, a star on GitHub helps other people find it, and [supporting Cyra](https://sandbox.flutterwave.com/pay/6f04lyagit1n) helps keep development moving forward.

## Acknowledgements & Upstream Attribution

Cyra is an independent open-source fork of [Vorssaint](https://github.com/vorssaintapp/vorssaint-utils). We express our gratitude to the original Vorssaint maintainers and contributors for creating such a capable foundation.

Cyra builds upon that work with:
- Native **Intel Mac (x86_64)** support in addition to Apple Silicon
- Distinct independent branding, code signature, and release pipeline
- Tailored localizations, performance improvements, and ongoing maintenance

*Cyra is independently developed and maintained, and is not affiliated with or endorsed by the original Vorssaint project.*

## License

[GPL 3.0 or later](LICENSE).
- Copyright (C) 2026 Vorssaint (original codebase)
- Copyright (C) 2026 Cyra contributors / cymphonikbeatz (modifications and additions)

The GPL license covers the source code; name, logo, and trademark policies are detailed in [TRADEMARKS.md](TRADEMARKS.md).

<p align="center">
  <sub>Maintained by <a href="https://github.com/cymphonikbeatz">@cymphonikbeatz</a></sub>
</p>
