...
The GPL license does not grant permission to use the Cyra name, logo, icon,
bundle identity, trade dress, official branding, or any signing identity
controlled by the project maintainer.

Official Cyra builds are distributed only by the project maintainer.
...
Do not present a modified build as Cyra or as an official release unless
