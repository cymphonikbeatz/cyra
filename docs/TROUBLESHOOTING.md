...
Open a report from the [new issue](https://github.com/cymphonikbeatz/cyra-utility/issues/new/choose) page, and see [support](../SUPPORT.md) for every way to get help.
