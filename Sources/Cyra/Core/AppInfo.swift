...
// Portions Copyright (C) 2026 Cyra contributors
...
enum AppInfo {
    ...
    static let copyright = "© 2026 Cyra (based on Vorssaint)"
    static let websiteURL = URL(string: "https://github.com/cymphonikbeatz/cyra-utility")!
    static let repositoryURL = URL(string: "https://github.com/cymphonikbeatz/cyra-utility")!
    ...
    /// True for the local "Cyra (Developer)" build (bundle id ends in `.dev`).
    ...
    static var buildCommit: String? {
        (Bundle.main.object(forInfoDictionaryKey: "CyraBuildCommit") as? String)
