...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "Cyra: suspensão normal",
        statusActiveUntil: "Cyra: ativo até",
        statusActiveIndefinite: "Cyra: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o Cyra",
        menuQuit: "Sair do Cyra",
        menuHide: "Ocultar o Cyra",
        ...
        notifyBatteryTitle: "Cyra desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O Cyra precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O Cyra precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O Cyra foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O Cyra precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O Cyra vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O Cyra vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do Cyra",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao Cyra (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o Cyra para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o Cyra completamente",
        advancedUninstallConfirmTitle: "Desinstalar o Cyra?",
        advancedUninstallConfirmBody: "O Cyra vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o Cyra",
        ...
        switcherEnable: "Usar o alternador do Cyra",
        ...
        uninstallerFDAHint: "Ative o Cyra na lista. Se ele não aparecer, clique no + e escolha o Cyra em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O Cyra pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O Cyra pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O Cyra não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do Cyra",
        ...
        updateNeedsApplicationsTitle: "Mova o Cyra para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o Cyra para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o Cyra",
        obStepWelcomeTitle: "Bem-vindo ao Cyra",
        ...
        obStepDoneBody: "O Cyra já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O Cyra agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o Cyra precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o Cyra a continuar crescendo",
        donateMessage: "O Cyra é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o Cyra a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o Cyra e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do Cyra no Discord está começando",
        discordIntroMessage: "A comunidade do Cyra é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir @cymphonikbeatz no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O Cyra agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do Cyra sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o Cyra pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela. O botão acima faz o mesmo quando você já consegue chegar aqui. Manter menos ícones na barra, ou menos métricas no Cyra, reduz bastante a chance.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o Cyra lá, ou configure o %@ para sempre mostrar o Cyra.",
        ...
        cleanerNotifDenied: "As notificações do Cyra estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o Cyra para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o Cyra em «Abrir ao iniciar sessão».",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Cyra: normal sleep",
        statusActiveUntil: "Cyra: awake until",
        statusActiveIndefinite: "Cyra: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Cyra",
        menuQuit: "Quit Cyra",
        menuHide: "Hide Cyra",
        ...
        notifyBatteryTitle: "Cyra disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "Cyra needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "Cyra needs your password to restore the Mac's normal sleep.",
        adminPromptRecover: "Cyra quit while the Mac's sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "Cyra needs your password to install the update.",
        adminPromptSudoersInstall: "Cyra will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Cyra will remove the password-free closed-lid rule.",

        settingsTitle: "Cyra Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted Cyra (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Cyra to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Cyra completely",
        advancedUninstallConfirmTitle: "Uninstall Cyra?",
        advancedUninstallConfirmBody: "Cyra will clear its permissions, remove its preferences and move to the Trash, then quit. This can't be undone from the app, but it stays in the Trash until you empty it.",
        ...
        keepAwakeAutoStart: "Keep Awake when Cyra opens",
        ...
        switcherEnable: "Use the Cyra switcher",
        ...
        uninstallerFDAHint: "Turn Cyra on in the list. If it isn't there, click + and pick Cyra from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "Cyra can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. Cyra can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. Cyra does not capture passwords.",
        ...
        updateNeedsApplicationsTitle: "Move Cyra to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag Cyra to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open Cyra",
        obStepWelcomeTitle: "Welcome to Cyra",
        ...
        obStepDoneBody: "Cyra is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Cyra now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Cyra needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help Cyra keep growing",
        donateMessage: "Cyra is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help Cyra keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star Cyra on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover Cyra and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The Cyra Discord community is just getting started",
        discordIntroMessage: "The Cyra community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow @cymphonikbeatz on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "Cyra can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If Cyra's icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Cyra from Applications or Spotlight: that rebuilds the icon and, if it's still hidden, opens this window. The button above does the same when you can already get here. Keeping fewer menu bar icons, or fewer Cyra metrics, makes it far less likely.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for Cyra there, or set %@ to always show Cyra.",
        ...
        cleanerNotifDenied: "Cyra notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag Cyra to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn Cyra on under Open at Login.",
