...
extension KillProcessFeatureStrings {
    static let enUS = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra needs administrator access to end “%@”."
    )
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O Cyra precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra’nın “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra a besoin d'un accès administrateur pour arrêter « %@ »."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra richiede l'accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra 需要管理员权限才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Cyra 需要管理員權限才能結束「%@」。"
    )
