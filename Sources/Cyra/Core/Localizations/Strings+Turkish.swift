...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "Cyra: normal uyku",
        statusActiveUntil: "Cyra: şu zamana kadar uyanık",
        statusActiveIndefinite: "Cyra: süresiz uyanık",
        ...
        menuAbout: "Cyra Hakkında",
        menuQuit: "Cyra'dan Çık",
        menuHide: "Cyra'yı Gizle",
        ...
        notifyBatteryTitle: "Cyra devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "Cyra'nın, Mac'i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "Cyra'nın, Mac'in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac'in uykusu kapalıyken Cyra kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "Cyra güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "Cyra, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "Cyra, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "Cyra Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "Cyra'ya verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve Cyra'yı Çöp Sepeti'ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "Cyra'yı tamamen kaldır",
        advancedUninstallConfirmTitle: "Cyra kaldırılsın mı?",
        advancedUninstallConfirmBody: "Cyra izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti'ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti'ni boşaltana kadar orada kalır.",
        ...
        keepAwakeAutoStart: "Cyra açılınca uyanık tut",
        ...
        switcherEnable: "Cyra değiştiricisini kullan",
        ...
        uninstallerFDAHint: "Listede Cyra'yı aç. Orada yoksa + düğmesine tıkla ve Uygulamalar'dan Cyra'yı seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "Cyra, resmi Homebrew yükleyicisiyle Terminal'i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. Cyra, kurulum komutuyla Terminal'i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal'e ihtiyaç duyar. Cyra parolaları yakalamaz.",
        ...
        updateNotifyTitle: "Cyra güncellemesi",
        ...
        updateNeedsApplicationsTitle: "Cyra’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. Cyra’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        obStart: "Cyra'yı aç",
        obStepWelcomeTitle: "Cyra'ya hoş geldin",
        ...
        obStepDoneBody: "Cyra Mac'inle ilgilenmeye başladı bile.",
        ...
        obLanguageUpdateBody: "Cyra artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar'dan değiştirebilirsin.",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için Cyra'nın Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları'ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "Cyra'nın gelişmesine destek ol",
        donateMessage: "Cyra ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "Cyra'nın gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub'da Cyra'ya yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub'da verilen bir yıldız, daha fazla kişinin Cyra'yı keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "Cyra Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "Cyra topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        communityIntroFollowButton: "X'te @cymphonikbeatz'i takip et",
        homebrewOfficialIntroTitle: "Artık resmî Homebrew kataloğunda",
        homebrewOfficialIntroMessage: "Cyra artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "Cyra simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac'lerde yaygındır), Cyra'yı Uygulamalar'dan veya Spotlight'tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar. Buraya zaten ulaşabiliyorsan yukarıdaki düğme de aynısını yapar. Menü çubuğunda daha az simge veya daha az Cyra metriği tutmak bunu çok daha az olası kılar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. Cyra’i orada arayın veya %@ uygulamasını Cyra’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "Cyra bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. Cyra'yı Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları'nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar'ı açın ve «Oturum açılırken aç» altında Cyra'yı açın.",
