...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "Cyra: reposo normal",
        statusActiveUntil: "Cyra: activo hasta",
        statusActiveIndefinite: "Cyra: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de Cyra",
        menuQuit: "Salir de Cyra",
        menuHide: "Ocultar Cyra",
        ...
        notifyBatteryTitle: "Cyra desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "Cyra necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "Cyra necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "Cyra se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "Cyra necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "Cyra creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "Cyra eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de Cyra",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a Cyra (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve Cyra a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar Cyra por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar Cyra?",
        advancedUninstallConfirmBody: "Cyra borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir Cyra",
        ...
        switcherEnable: "Usar el selector de Cyra",
        ...
        uninstallerFDAHint: "Activa Cyra en la lista. Si no aparece, haz clic en + y elige Cyra en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "Cyra puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. Cyra puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. Cyra no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de Cyra",
        ...
        updateNeedsApplicationsTitle: "Mueve Cyra a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra Cyra a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir Cyra",
        obStepWelcomeTitle: "Te damos la bienvenida a Cyra",
        ...
        obStepDoneBody: "Cyra ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "Cyra ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, Cyra necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que Cyra siga creciendo",
        donateMessage: "Cyra es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que Cyra siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a Cyra en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran Cyra y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de Cyra en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de Cyra es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a @cymphonikbeatz en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "Cyra ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de Cyra desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir Cyra desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana. El botón de arriba hace lo mismo cuando ya puedes llegar hasta aquí. Mantener menos iconos en la barra de menús, o menos métricas en Cyra, lo hace mucho menos probable.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca Cyra ahí, o configura %@ para mostrar siempre Cyra.",
        ...
        cleanerNotifDenied: "Las notificaciones de Cyra están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra Cyra a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa Cyra en «Abrir al iniciar sesión».",
