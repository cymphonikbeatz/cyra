...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "Cyra: normaler Ruhezustand",
        statusActiveUntil: "Cyra: aktiv bis",
        statusActiveIndefinite: "Cyra: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über Cyra",
        menuQuit: "Cyra beenden",
        menuHide: "Cyra ausblenden",
        ...
        notifyBatteryTitle: "Cyra deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "Cyra benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "Cyra benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "Cyra wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "Cyra benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "Cyra legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "Cyra entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "Cyra-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du Cyra erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt Cyra in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "Cyra vollständig deinstallieren",
        advancedUninstallConfirmTitle: "Cyra deinstallieren?",
        advancedUninstallConfirmBody: "Cyra setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von Cyra wach halten",
        ...
        switcherEnable: "Cyra-Umschalter verwenden",
        ...
        uninstallerFDAHint: "Aktiviere Cyra in der Liste. Fehlt es dort, klicke auf + und wähle Cyra unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "Cyra kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. Cyra kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. Cyra erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege Cyra in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe Cyra in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        obStart: "Cyra öffnen",
        obStepWelcomeTitle: "Willkommen bei Cyra",
        ...
        obStepDoneBody: "Cyra kümmert sich bereits um deinen Mac.",
        ...
        obLanguageUpdateBody: "Cyra spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt Cyra die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf Cyra weiter zu wachsen",
        donateMessage: "Cyra ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft Buy Me a Coffee direkt dabei, sie voranzubringen.",
        donateButton: "Über Buy Me a Coffee unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf Cyra weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist Buy Me a Coffee der einzige Ort dafür.",
        supportIntroStarButton: "Cyra auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, Cyra zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        ...
        discordIntroTitle: "Die Cyra Community auf Discord steht noch am Anfang",
        discordIntroMessage: "Die Cyra Community ist neu und wächst noch. Tritt früh bei, lerne andere Nutzer kennen und hilf, einen einladenden Ort rund um die App aufzubauen.",
        ...
        communityIntroFollowButton: "@cymphonikbeatz auf X folgen",
        homebrewOfficialIntroTitle: "Jetzt im offiziellen Katalog von Homebrew",
        homebrewOfficialIntroMessage: "Cyra kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von Cyra verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne Cyra erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster. Der Knopf oben bewirkt dasselbe, wenn du bereits hierher gelangst. Weniger Symbole in der Menüleiste oder weniger Cyra-Werte machen es deutlich unwahrscheinlicher.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche Cyra dort, oder stelle %@ so ein, dass Cyra immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von Cyra sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe Cyra in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte Cyra unter „Bei der Anmeldung öffnen“ ein.",
