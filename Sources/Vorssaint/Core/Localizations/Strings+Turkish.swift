...
extension Strings {
    static let tr = Strings(
        ...
        menuQuit: "Cyra'ten Çık",
        menuHide: "Cyra'i Gizle",
        ...
        adminPromptClamshellOn: "Cyra'in, Mac'i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "Cyra'in, Mac'in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        ...
        advancedResetDescription: "Cyra'e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve Cyra'i Çöp Sepeti'ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "Cyra'i tamamen kaldır",
        ...
        uninstallerFDAHint: "Listede Cyra'i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar'dan Cyra'i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        obStart: "Cyra'i aç",
        obStepWelcomeTitle: "Cyra'e hoş geldin",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için Cyra'in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları'ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "Cyra'in gelişmesine destek ol",
        ...
        supportIntroTitle: "Cyra'in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub'da Cyra'e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub'da verilen bir yıldız, daha fazla kişinin Cyra'i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        ...
        showMenuBarIconCaption: "Cyra simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac'lerde yaygındır), Cyra'i Uygulamalar'dan veya Spotlight'tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar. Buraya zaten ulaşabiliyorsan yukarıdaki düğme de aynısını yapar. Menü çubuğunda daha az simge veya daha az Cyra metriği tutmak bunu çok daha az olası kılar.",
        ...
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. Cyra'i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları'nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar'ı açın ve «Oturum açılırken aç» altında Cyra'i açın.",
