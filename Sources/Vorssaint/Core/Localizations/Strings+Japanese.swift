...
extension Strings {
    static let ja = Strings(
        statusIdleTooltip: "Cyra：通常のスリープ",
        statusActiveUntil: "Cyra：次の時刻までスリープしない",
        statusActiveIndefinite: "Cyra：解除するまでスリープしない",
        ...
        notifyBatteryTitle: "Cyra をオフにしました",
        notifyBatteryBody: "バッテリー残量が少なくなりました。充電を保護するため通常のスリープに戻しました。",
        adminPromptClamshellOn: "ふたを閉じても続けるには、Cyra にパスワードが必要です。",
        adminPromptClamshellOff: "Mac の通常のスリープを元に戻すにはパスワードが必要です。",
        adminPromptRecover: "Mac のスリープを無効化したまま Cyra が終了しました。通常のスリープに戻すにはパスワードを入力してください。",
        adminPromptUpdate: "アップデートをインストールするには Cyra にパスワードが必要です。",
        adminPromptSudoersInstall: "ふたを閉じたモードをパスワードなしで切り替えられるよう、Cyra が制限付きルール（pmset disablesleep のみ）を作成します。パスワードが必要なのはこの一度きりです。",
        adminPromptSudoersRemove: "パスワード不要のふたを閉じたモードのルールを Cyra が削除します。",

        settingsTitle: "Cyra 設定",
        tabGeneral: "一般",
        tabEnergy: "省エネルギー",
        ...
        advancedResetDescription: "Cyra に許可したすべてのアクセス権（アクセシビリティ、画面収録、フルディスクアクセスなど）、ログイン項目、ふたを閉じたモードのルールを削除します。最初からやり直すときや、アンインストールの前に便利です。アプリはインストールされたまま残ります。",
        ...
        advancedUninstallDescription: "上記をすべて実行したうえで、環境設定を削除し、Cyra をゴミ箱に移動して、何も残しません。完了後にアプリは終了します。いつでも再インストールできます。",
        advancedUninstallButton: "Cyra を完全にアンインストール",
        advancedUninstallConfirmTitle: "Cyra をアンインストールしますか？",
        advancedUninstallConfirmBody: "Cyra はアクセス権を消去し、環境設定を削除し、ゴミ箱に移動してから終了します。この操作はアプリからは取り消せませんが、ゴミ箱を空にするまではゴミ箱に残ります。",
        ...
        keepAwakeAutoStart: "Cyra起動時にスリープを防ぐ",
        ...
        switcherEnable: "Cyra のスイッチャーを使う",
        ...
        uninstallerFDAHint: "リストで Cyra をオンにします。表示されない場合は + をクリックし、アプリケーションから Cyra を選びます。アクセス権はアプリを再度開いた後に有効になります。",
        ...
        homebrewMissingBody: "Cyra は公式 Homebrew インストーラを Terminal で開けます。Terminal に手順が表示され、必要ならパスワードを求められます。",
        ...
        homebrewShellSetupBody: "Homebrew はインストールされていますが、Terminal がまだ brew コマンドを見つけられない場合があります。Cyra は設定コマンドを Terminal で開けます。",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために Terminal が必要です。Cyra はパスワードを取得しません。",
        ...
        updateNotifyTitle: "Cyra のアップデート",
        updateInstallFailedBody: "アップデートはダウンロードされましたが、適用できませんでした。GitHub のリリースページから最新版をダウンロードし、現在のアプリの上にドラッグして置き換えてください。",
        updateNeedsApplicationsTitle: "Cyra を「アプリケーション」に移動してください",
        updateNeedsApplicationsBody: "アプリが、ディスクイメージやシステムの一時的な場所など、アップデートできない場所から実行されています。Cyra を「アプリケーション」フォルダにドラッグし、そこから開いてからもう一度お試しください。",
        ...
        obStepDoneBody: "Cyra はすでにあなたの Mac を見守っています。",
        ...
        obLanguageUpdateBody: "Cyra が複数の言語に対応しました。使いたい言語を選んでください。設定でいつでも変更できます。",
        ...
        cleaningNeedsAxBody: "キーボードを安全にロックするには、Cyra にアクセシビリティのアクセス権が必要です。システム設定で許可して、もう一度お試しください。",
        ...
        donateHeading: "Cyra の成長を支える",
        donateMessage: "Cyra は無料で独立したアプリとして、わたしの空き時間に開発しています。金銭的に支援したい場合は、Buy Me a Coffee が開発の継続に直接役立ちます。",
        donateButton: "Buy Me a Coffee で支援する",
        donateThanks: "来てくれてありがとう。🖤",
        supportIntroTitle: "Cyra の成長を支える",
        supportIntroMessage: "開発を金銭的に支援したい場合は、Buy Me a Coffee が唯一の窓口です。",
        supportIntroStarButton: "GitHub で Cyra にスターを付ける",
        supportIntroStarMessage: "金銭的な支援は決して必要ではありません。GitHub のスターは、より多くの人が Cyra を見つける助けになり、開発にも大きな力になります。",
        supportIntroCoffeeButton: "Buy Me a Coffee で支援する",
        supportIntroLaterButton: "今はしない",
        supportIntroDoneButton: "完了",
        discordIntroTitle: "CyraのDiscordコミュニティが始まります",
        discordIntroMessage: "Cyra コミュニティは新しく、まだ成長の途中です。早い段階から参加して他のユーザーと出会い、アプリを囲む心地よい場所を一緒につくりましょう。",
        ...
        communityIntroFollowButton: "Xで@cymphonikbeatzをフォロー",
        homebrewOfficialIntroTitle: "Homebrew 公式カタログに登場",
        homebrewOfficialIntroMessage: "Cyra を Homebrew 公式カタログから直接インストールできるようになりました。",
        ...
        showMenuBarIconCaption: "Cyra のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から Cyra を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。ここまでたどり着けるなら、上のボタンでも同じことができます。メニューバーのアイコンを減らすか、Cyra の計測値を減らすと、起こりにくくなります。",
        ...
        menuBarIconManagerHintFormat: "%@ が起動中で、アイコンを隠しセクションにしまっている可能性があります。そこで Cyra を探すか、%@ で Cyra を常に表示する設定にしてください。",
        ...
        cleanerNotifDenied: "Cyra の通知がシステムでオフになっています。",
        cleanerNotifOpenSettings: "通知設定を開く…",
        launchAtLoginNeedsApplications: "ログイン時に開けない場所からアプリが実行されています。Cyraをアプリケーションフォルダにドラッグし、そこから開いてもう一度オンにしてください。",
        launchAtLoginNeedsApproval: "ログイン項目は登録されていますが、システム設定ではオフのままです。「システム設定 › 一般 › ログイン項目と機能拡張」を開き、「ログイン時に開く」でCyraをオンにしてください。",
