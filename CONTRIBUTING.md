...
Cyra ships these locales today: English (US), Português (Brasil),
...
[new issue](https://github.com/cymphonikbeatz/cyra-utility/issues/new/choose) page.
...
6. Settle the direction before writing the code. Scope is the most common
   ...
   switch it on. Cyra reaches for what macOS almost does; it does not
